...
|----|--------|--------------|--------|----------------|--------------------|
| CT001 | Login com credenciais válidas | Usuário cadastrado no sistema | 1. Acessar a tela de login<br>2. Informar e-mail válido<br>3. Informar senha válida<br>4. Clicar no botão “Entrar” | email: email@test.com<br>senha: 123456 | Usuário autenticado e redirecionado para a página inicial |
